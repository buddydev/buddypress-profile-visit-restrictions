...
/**
 * Auto Loader for BP_Profile_Visit_Restrictions.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the BP_Profile_Visit_Restrictions\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/bp-skeleton/src/bar/baz/class-qux.php:
 *
 *      new BP_Profile_Visit_Restrictions\Baz_Xyz\Qux;
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. BP_Profile_Visit_Restrictions\\(escaped slashes);
	 *
	 * @var string
	 */
